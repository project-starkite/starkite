...
const ModuleName starbase.ModuleName = "ai"

// Module implements the starbase Module interface.
//
// Lifetime: one instance per Registry. Thread-safety is required because
// starbase threads share the module value across script invocations.
type Module struct {
	loadOnce sync.Once
