...
1. **Deployment** — runs `kite-cloud run webhook.star` with TLS certs mounted
...
Use `kite-cloud kube gen-webhook-artifacts` to generate all manifests:
