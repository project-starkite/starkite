...
For a deep dive, see [Language](../concepts/language.md) and the [Starlark spec](https://github.com/bazelbuild/starlark/blob/master/spec.md).
...
-   :material-rocket-launch:{ .lg .middle } __Quickstarts__

    ---

    Short capability demos: HTTP, exec, SSH, CLI, sandbox, Kubernetes, MCP.

    [:octicons-arrow-right-24: Quickstarts](quickstarts/first-script.md)

-   :material-lightbulb-outline:{ .lg .middle } __Concepts__

    ---

    Editions, security model, language, modules, and embedding.
